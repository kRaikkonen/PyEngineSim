...
def lamborghini_aventador_v12() -> Engine:
    ...
    return Engine(
        ...
        # ...a VOICING of the classic voice.  The car itself has mirror-image
        # bank manifolds: measured on a real pass, its 9th and 15th orders sit
        # 28-30 dB under the 6th going away -- no room for a 9-deg offset.  The
        # physical voice uses the measurement.
        header_unequal_phys_deg=0.0,
